...
const { default: VNode } = require("../../src/core/vdom/vnode");
...
module.exports = function weexFactory(exports, renderer) {
  ...
  function defineReactive$$1(
    ...
    // Object.getOwnPropertyDescriptor 获取数据的属性描述
    // 1 configurable 设置属性是否可以被删除 是否可更改
  ...
  /**
   * 判断新旧两个虚拟 DOM 是否相同
   * @param {VNode} a Virtual DOM
   * @param {VNode} b Virtual DOM
   */
